...
module.exports = class Ticket{
    ...
    static fetchAll_Progreso(){
        return db.execute('SELECT t.Id_Ticket,t.Descripcion,t.Asunto,t.Fecha_Inicio,t.Id_Prioridad,t.Id_Estado,t.Fecha_y_Hora FROM ticket_archivo_magia t GROUP BY t.Id_Ticket HAVING MAX(t.Fecha_y_Hora)')
    }
