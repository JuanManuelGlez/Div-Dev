...
module.exports = class Ticket {
    ...
    static fetchList() {
        return db.execute('SELECT t.Id_Ticket,t.Asunto,t.Descripcion,t.Fecha_Inicio,t.Id_Prioridad,t.Id_Estado FROM ticket t WHERE t.Archivado = 0 ORDER BY t.Fecha_Inicio DESC');
    }
    ...
    static fetchListArchivo() {
        return db.execute('SELECT t.Id_Ticket,t.Asunto,t.Fecha_Inicio,t.Descripcion, t.Id_Prioridad,t.Id_Estado FROM ticket t WHERE t.Archivado = 1 ORDER BY t.Fecha_Inicio DESC');
    }
    ...
    static assignUsuarioFirst(id_ticket, id_usuario, cargo) {
        return db.execute('INSERT INTO usuario_ticket (Id_Usuario, Id_Ticket, Cargo, Fecha_Asignacion) VALUES (?, ?, ?, CURRENT_TIMESTAMP)',
